...
public class User implements Serializable {
	...
	/**
	 * Construtor com inicializa��o de todos atributos da classe.
	 * 
	 * @param id
	 * @param fullName
	 * @param email
	...
	public String toString() {
		return new StringBuffer("User [id = ").append(String.valueOf(id))
				.append(", name = ").append(name).append(", password = ")
				.append(password).append(", fullName = ").append(fullName)
